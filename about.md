...
### sql+dsl 기반 데이터(polars+pandas) 분석 플랫폼 개발 (21.11.01 ~ 현재, 1년 7개월, GS 인증 진행중)
...
### dsl 기반 빅데이터(spark) 분석 플랫폼 (레거시) 유지보수 (21.01.01 ~ 현재, 2년 5개월)
